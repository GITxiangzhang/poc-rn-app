    ...
    return (
      <View style={styles.container}>
        {/* <View style={{backgroundColor: 'green'}}>
          <Text style={{textAlign: 'center'}}>IN THIS TOPIC</Text>
          <Text>Dive into the world of coding and master principles by writing real code in JavaScript, a opular language.</Text>
          </View> */}
        <View style={{marginTop: 150, flex: 1, backgroundColor: '#f6f7fe'}}>
        <View style={{backgroundColor: '#beffe7', margin: 10,marginTop: -40, borderRadius: 4, color: 'red'}}>
          <Text style={{textAlign: 'center'}}>IN THIS TOPIC</Text>
          <Text>Dive into the world of coding and master principles by writing real code in JavaScript, a opular language.</Text>
          </View>
          <TouchableOpacity
