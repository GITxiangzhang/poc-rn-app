...
export default class Camera extends React.Component {
  ...
  recordBtn () {
    if (this.camera && this.state.isRecording) {
      return (<TouchableOpacity onPress={this.stopRecord.bind(this)} style={styles.capture}>
        <Text style={{ fontSize: 14 }}> 停止 </Text>
      </TouchableOpacity>)
    } else {
      return (<TouchableOpacity onPress={this.takeRecord.bind(this)} style={styles.capture}>
